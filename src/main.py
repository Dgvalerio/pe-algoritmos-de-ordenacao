...
items = [
    # Random
    {"type": 'number', "order": 'random', "quantity": '10k', "bubble": random_10k_bubble.result, "heap": random_10k_heap.result, "insertion": random_10k_insertion.result, "merge": random_10k_merge.result},
    {"type": 'number', "order": 'random', "quantity": '50k', "bubble": random_50k_bubble.result, "heap": random_50k_heap.result, "insertion": random_50k_insertion.result, "merge": random_50k_merge.result},
    {"type": 'number', "order": 'random', "quantity": '100k', "bubble": random_100k_bubble.result, "heap": random_100k_heap.result, "insertion": random_100k_insertion.result, "merge": random_100k_merge.result},
    # Descending
